...
const ACTIVE_NOW_MS: i64 = 1_785_204_000_000;
const AFTER_EXPIRY_MS: i64 = 1_785_376_800_000;
...
#[test]
fn published_monitor_failure_is_an_upstream_failure() {
    let error =
        decode_reset_radar(&fixture("monitor-error.json"), ACTIVE_NOW_MS).expect_err("monitor");
